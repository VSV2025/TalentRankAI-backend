...
class VectorRetriever:
    ...
    def _get_cross_encoder(self):
        # Cross-encoder requires ~300MB RAM. Disabled by default to prevent OOM
        # on memory-constrained deployments. Opt in with ENABLE_CROSS_ENCODER=true.
        if os.environ.get("ENABLE_CROSS_ENCODER", "").lower() not in ("1", "true", "yes"):
            return None
